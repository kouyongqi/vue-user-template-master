<template>
  <div class="Page Confirm">
    <div class="Title">
      ...
      <img src="~/assets/img/cart_setp2.png" class="fr" width="500px">
      <div class="clear"></div>
    </div>
...
<script>
import { getOrderNoInfo } from '/api/order'
...
export default {
    ...
    methods:{
         getOrderInfo(){
             getOrderNoInfo(this.$route.params.orderno)
               .then(response =>{
                   this.order = response.data.data.orderinfo  //response.data获取到返回的json对象
               })
         },
