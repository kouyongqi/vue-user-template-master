...
<script>
import { getTeacherAndCourseList } from '/api/teacher'
export default {
     data(){
     return {
       teacher:{},
   ...
   created(){
      this.getTeacherInfoAndCourseInfo(this.$route.params.teacherid)
   },

   methods:{
     getTeacherInfoAndCourseInfo(teacherid){
       getTeacherAndCourseList(teacherid)
        .then(response =>{
